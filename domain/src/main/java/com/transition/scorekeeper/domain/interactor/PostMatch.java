 ...
 * @since 11/06/16
 */
public class PostMatch extends UseCase {
    private final MatchRepository matchRepository;
    private Match match;

    @Inject
    public PostMatch(MatchRepository matchRepository, ThreadExecutor threadExecutor,
    ...
    protected Observable buildUseCaseObservable() {
        return this.matchRepository.postMatch(this.match);
    }
}
